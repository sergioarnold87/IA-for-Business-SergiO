...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec 28 16:49:36 2021
...
env = Entorno.Environment(optimal_temperature = (18.0, 24.0), initial_month = 0, initial_number_users = 20, initial_rate_data = 30)
...
dqn = Algoritmo_Q_Learning.DQN(max_memory = max_memory, discount_factor = 0.9)
